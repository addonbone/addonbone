import {ServiceDefinition, ServiceInit, ServiceType} from "@typing/service";
...
export const isValidServiceInitFunction = <T extends ServiceType>(init: any): init is ServiceInit<T> => {
    return init && typeof init === 'function';
}

export const isValidServiceMainFunction = <T extends ServiceType>(main: any): main is ServiceInit<T> => {
