...
export type MessageTargetHandler<T extends MessageMap, K extends MessageType<T>> = (data: MessageData<T, K>, sender: MessageSender) => MessageResponse<T, K>
export type MessageMapHandler<T extends MessageMap> = { [K in MessageType<T>]?: MessageTargetHandler<T, K> }
...
export interface MessageHandler<T extends MessageMap> {
